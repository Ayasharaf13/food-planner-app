...
public class PlannerAdapterChild extends ListAdapter<RandomMeal, PlannerAdapterChild.ViewHolder> {

    InterfaceAdapter deleteItemPlanner;

    public PlannerAdapterChild(InterfaceAdapter deleteItemPlanner){
